...
def link299():
    getList(
        datea=None,
        content="article > p:not(.posts--meta)",
        imajina=".post--image > img",
        pagis=0,
        getDatea=None,
        replaceRegex=None,
        numero="299",
        LA_name="Ards and North Down",
        LA_pr="https://www.ardsandnorthdown.gov.uk/news",
        links="https://www.ardsandnorthdown.gov.uk/news/P",
        listas=".posts--post",
        datesss=".posts--meta",
        replaceDate=None,
        title="h2",
...
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="299",LA_name="Ards and North Down",LA_pr="https://www.ardsandnorthdown.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
