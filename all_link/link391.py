...
def link391():
    getList(
        ...
        numero="391",
        LA_name="Ashford",
        LA_pr="https://news.ashford.gov.uk/",
      datea="#contentbody > div > div > div:nth-child(2) > div.newsContentTitle > span",
        content=".bodyContent",
        imajina="#contentbody > div > div > div.col-sm-12.itemtopimage > img",
        pagis=1,
        getDatea=getDatea,
        replaceRegex="\d{1,2}\/\d{1,2}\/\d{4}",
        links="https://www.ashford.gov.uk/news/latest-news/?page=",
        listas=".col-md-3.nhNewsItemOuter.wireframe",
        datesss="div",
        replaceDate=None,
        title="a",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.ashford.gov.uk",
        href="a",
        linkedin2="https://www.ashford.gov.uk",
        dayfirst=True
    )
