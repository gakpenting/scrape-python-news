...
def link275():
    getList(
        datea=None,
        content=".fullBlock.wysiwyg > *:not(header)",
        imajina="sam",
        pagis=1,
        getDatea=None,
        replaceRegex=None,
        numero="275",
        LA_name="Lancaster",
        LA_pr="https://www.lancaster.gov.uk/news",
        links=None,
        listas=".promo",
        datesss=".articleDate",
        replaceDate=None,
        ...
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.lancaster.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="275",LA_name="Lancaster",LA_pr="https://www.lancaster.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
    ...
    try:
        ...
        while True:
            namber=str(number)
            setop=False
            loki="https://www.lancaster.gov.uk/news/%s?page=" % (str(datetime.now().year))
            link=loki+namber
