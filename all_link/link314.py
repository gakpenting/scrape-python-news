...
def link314():
    getList(
        ...
        replaceRegex=None,
        numero="314",
        LA_name="Clackmannanshire",
        LA_pr="https://www.clacks.gov.uk/biodiversity/latest_news.html",
        links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="314",LA_name="Clackmannanshire",LA_pr="https://www.clacks.gov.uk/biodiversity/latest_news.html",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
