...
def link351():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="351",LA_name="Cardiff",LA_pr="https://www.cardiff.gov.uk/ENG/Your-Council/News/Pages/default.aspx",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
