...
numero="395",
LA_name="Colchester",
LA_pr="https://www.colchester.gov.uk/info/category/?id=latest-news",
    links="https://www.colchester.gov.uk/info/category/?id=latest-news",
    listas=".cbc-press-content",
    datesss=".overlay-date",
    replaceDate=None,
    title="h2",
    getBody=getBody,
    content=".kb-content > p:not(:first-child)",
    imajina="sam",
    linkedin="https://www.colchester.gov.uk",
    href="a",
    linkedin2="")
