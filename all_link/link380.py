...
def link380():
    getList(
        ...
        numero="380",
        LA_name="East Ayrshire",
        LA_pr="east-ayrshire.gov.uk/news",
      datea=None,
        content=".news-roll > p",
        imajina=".eb-image-viewport > img",
        pagis=1,
        getDatea=None,
        replaceRegex=None,
        
        links="https://www.east-ayrshire.gov.uk/News/page/",
        listas=".news-roll > div > div:not(.article-contacts)",
        datesss=".news-meta",
        replaceDate=None,
        title="strong",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.east-ayrshire.gov.uk",
        href="a",
        linkedin2=""
    )
        ...
        while True:
            ...
            for a in lista:
                ...
                if compareDate(s,lastDate):
                    ...
                    newstring = pattern.sub("", a.select_one("a").get("style")) if a.select_one("a").get("style") else ""
