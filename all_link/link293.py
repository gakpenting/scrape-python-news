...
def link293():
    getList(
        ...
        numero="293",
        LA_name="Selby",
        LA_pr="https://www.selby.gov.uk/eastern-cef-latest-news",
        links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="293",LA_name="Selby",LA_pr="https://www.selby.gov.uk/eastern-cef-latest-news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
