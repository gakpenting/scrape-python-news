...
def link250():
    getList(
        datea=None,
        content=".news-article > div > div > p",
        imajina="sam",
        pagis=1,
        getDatea=None,
        replaceRegex=None,
        numero="250",
        LA_name="Wandsworth",
        LA_pr="https://www.wandsworth.gov.uk/news",
        links="https://www.wandsworth.gov.uk/news",
        listas=".story",
        datesss=".added-date",
        replaceDate=None,
        title="h3",
        getBody=getBody,
        imajinasi="img",
        linkedin="https://www.wandsworth.gov.uk",
        href="a",
        linkedin2="https://www.wandsworth.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="250",LA_name="Wandsworth",LA_pr="https://www.wandsworth.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
