...
def link316():
    getList(
        datea=".a-body > p:first-child",
        content=".a-body > p:not(:first-child)",
        imajina=".a-relimage > img",
        pagis=1,
        getDatea=getDatea,
        numero="316",
        LA_name="East Renfrewshire",
        LA_pr="https://www.eastrenfrewshire.gov.uk/article/5429/All",
        links="https://www.eastrenfrewshire.gov.uk/news?p=",
        listas="#maincontent > div > div > div.grid__cell.grid__cell--bodycopy.grid__cell--cols3 > div > div.grid.grid--list.grid--1col > div",
        datesss=None,
...
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="316",LA_name="East Renfrewshire",LA_pr="https://www.eastrenfrewshire.gov.uk/article/5429/All",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
