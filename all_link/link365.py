...
def link365():
    getList(
        ...
        imajina="body > div.container-fluid > div:nth-child(3) > div.col-xs-24.col-xs-offset-0.col-sm-15.col-sm-offset-1 > div > div.news-content > p > img",
        pagis=1,
        getDatea=None,
        replaceRegex=None,
        numero="365",
        LA_name="Stratford-on-Avon",
        LA_pr="https://www.stratford.gov.uk/#news",
        links="https://www.stratford.gov.uk/news/press.cfm/current/",
        listas=".news-list-item",
        datesss="small.text-muted",
        replaceDate=None,
        title="h5",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.stratford.gov.uk",
        href="a",
        linkedin2="https://www.stratford.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="365",LA_name="Stratford-on-Avon",LA_pr="https://www.stratford.gov.uk/#news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
