...
def link303():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="303",LA_name="Mid and East Antrim",LA_pr="https://www.mynewsdesk.com/uk/meabc",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
