...
def link311():
    getList(
        ...
        numero="311",
        LA_name="Rutland",
        LA_pr="https://www.rutland.gov.uk/my-council/council-news/",
        links="https://www.rutland.gov.uk/my-council/council-news/?newsp=",
        ...
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.rutland.gov.uk",
        href="a",
        linkedin2="https://www.rutland.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="311",LA_name="Rutland",LA_pr="https://www.rutland.gov.uk/my-council/council-news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
