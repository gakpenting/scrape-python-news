...
def link349():
    getList(
        datea=None,
        content="#main-content > div > section > div > div > div:nth-child(1) > div > div.row > div.col-md-8 > article > div > div > section > div > div > div > div",
        imajina="sam",
        pagis=1,
        getDatea=None,
        replaceRegex=None,
        numero="349",
        LA_name="Bridgend",
        LA_pr="https://www.bridgend.gov.uk/news/",
        links="https://www.bridgend.gov.uk/news/?cat=&date=&p=",
        listas=".news-listing-article__body",
        datesss=".news-listing-article__date",
        replaceDate=None,
        title=".news-listing__link",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.bridgend.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="349",LA_name="Bridgend",LA_pr="https://www.bridgend.gov.uk/news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
