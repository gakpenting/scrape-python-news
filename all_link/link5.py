...
def link5():
    getList(
      ...
      datea=None,
        content="#block-bexley-content > article > div > div.field.field--name-field-news-content.field--type-entity-reference-revisions.field--label-hidden.field__items > div > section > div",
        imajina="#block-bexley-content > article > div > div.field.field--name-field-news-image.field--type-image.field--label-hidden.field__item > img",
        pagis=0,
        getDatea=None,
        replaceRegex=None,
        links="https://www.bexley.gov.uk/news?category=All&date=All&page=",
        listas="article[role='article']",
        datesss=".news__date",
        replaceDate=None,
        title="h4",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.bexley.gov.uk",
        href="a",
        linkedin2="https://www.bexley.gov.uk",
        dayfirst=False
    )
