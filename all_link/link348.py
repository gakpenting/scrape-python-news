...
def link348():
    getList(
        ...
        replaceRegex=None,
        numero="348",
        LA_name="Blaenau Gwent",
        LA_pr="https://www.blaenau-gwent.gov.uk/en/story/news/work-begins-on-flagship-recycling-centre/",
        links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="348",LA_name="Blaenau Gwent",LA_pr="https://www.blaenau-gwent.gov.uk/en/story/news/work-begins-on-flagship-recycling-centre/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
