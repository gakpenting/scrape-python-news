...
def link300():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="300",LA_name="Armagh City, Banbridge and Craigavon",LA_pr="https://www.armaghbanbridgecraigavon.gov.uk/news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
