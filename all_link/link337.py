...
def link337():
    getList(
        datea=None,
        content="#news-listing-page-show > div.container.page-content > div > div.col-xs-12.col-sm-12.col-md-9.col-lg-9.left-column > *:not(h1):not(.published-date):not(.clearfix)",
        imajina=".leftAlone",
        pagis=0,
        getDatea=None,
        ...
        numero="337",
        LA_name="Suffolk",
        LA_pr="https://www.suffolk.gov.uk/council-and-democracy/council-news/",
        links="https://www.suffolk.gov.uk/council-and-democracy/council-news/?start=",
        listas=".news-item",
        datesss=".published-date",
        replaceDate=None,
        title="h3",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.suffolk.gov.uk",
        href="a",
        linkedin2="https://www.suffolk.gov.uk/"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="337",LA_name="Suffolk",LA_pr="https://www.suffolk.gov.uk/council-and-democracy/council-news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
