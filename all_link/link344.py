...
def link344():
    getList(
        ...
        numero="344",
        LA_name="Woking",
        LA_pr="https://www.woking.gov.uk/news-list",
        links="https://www.woking.gov.uk/news-list?page=",
        listas="tbody > tr",
...
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="344",LA_name="Woking",LA_pr="https://www.woking.gov.uk/news-list",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
