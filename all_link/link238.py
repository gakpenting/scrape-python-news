...
def link238():
    getList(
        datea=None,
        content=".span9 > *:not(h3):not(h2):not(:nth-of-type(1))",
        imajina="sam",
        pagis=1,
        getDatea=None,
        replaceRegex=None,
        ...
        listas="#content > ul.unstyled > li",
        datesss="a",
        replaceDate=None,
        title="li",
        getBody=getBody,
        imajinasi="sam",
        linkedin="http://www.brentwood.gov.uk/",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="238",LA_name="Brentwood",LA_pr="http://www.brentwood.gov.uk/index.php?cid=826",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
    ...
    try:
        ...
        if r.headers['content-type']=="application/json":
            ...
            # print(soup)
        lista=soup.select("ul.unstyled")[1].select("li")
        ...
        for a in lista:
            ...
            titulos=re.sub(r"^\d{1,2}\s\w+\s\d{1,4},","",a.select_one("a").get("title")) if a.select_one("a").get("title") else ""
