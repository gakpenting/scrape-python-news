...
def link262():
    getList(
        datea=None,
        content=".page-body > *:not(h2):not(.dateline)",
        imajina=".page-body > img",
        pagis=1,
        getDatea=None,
        replaceRegex=None,
        numero="262",
        LA_name="Southampton",
        LA_pr="https://www.southampton.gov.uk/news/",
        links="https://www.southampton.gov.uk/news/allnews.aspx?page=",
        listas=".pagedList > ul > li",
        datesss=".articleDate",
        replaceDate=None,
        title="a",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.southampton.gov.uk",
        href="a",
        linkedin2="https://www.southampton.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="262",LA_name="Southampton",LA_pr="https://www.southampton.gov.uk/news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
