...
def link346():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="346",LA_name="Newcastle upon Tyne",LA_pr="https://www.newcastle.gov.uk/citylife-news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
