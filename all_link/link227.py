...
def link227():
    getList(
        datea="#mainContent > div > p",
        content=".body-text > p",
        imajina=".body-text > p > img",
        pagis=1,
        getDatea=getDatea,
        replaceRegex=None,
        numero="227",
        LA_name="Huntingdonshire",
        LA_pr="https://www.huntingdonshire.gov.uk/news/",
        links="https://www.huntingdonshire.gov.uk/news/",
        listas=".archiveMonth > ul > li",
        datesss=None,
        replaceDate=None,
        title="h3",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.huntingdonshire.gov.uk",
        href="a",
        linkedin2="https://www.huntingdonshire.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="227",LA_name="Huntingdonshire",LA_pr="https://www.huntingdonshire.gov.uk/news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
