...
def link305():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="305",LA_name="Ashfield",LA_pr="https://www.ashfield.gov.uk/mediacentre/news-and-updates/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
