...
def link381():
    getList(
        ...
        numero="381",
        LA_name="East Dunbartonshire",
        LA_pr="eastdunbarton.gov.uk/news/",
      datea=None,
        ...
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://eastdunbarton.gov.uk",
        href="a",
        linkedin2="https://eastdunbarton.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="379",LA_name="Wychavon",LA_pr="https://www.wychavon.gov.uk/news-and-alerts",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
    ...
    try:
        ...
        while True:
            namber=str(number)
            setop=False
            capin="https://eastdunbarton.gov.uk/council/news/news-%s?page=" % (str(datetime.now().year))
            link=capin+namber
