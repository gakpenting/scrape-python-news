...
def link336():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="336",LA_name="Staffordshire Moorlands",LA_pr="https://www.staffsmoorlands.gov.uk/article/416/News--Events",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
