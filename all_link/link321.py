...
def link321():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="321",LA_name="North Lanarkshire",LA_pr="https://www.northlanarkshire.gov.uk/index.aspx?articleid=12455",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
