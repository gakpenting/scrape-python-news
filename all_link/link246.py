...
def link246():
    getList(
        ...
        LA_pr="https://www.rbkc.gov.uk/newsroom-rbkc",
        links="https://www.rbkc.gov.uk/newsroom-rbkc",
        listas="article",
        datesss=".news-item__date",
        replaceDate=None,
        title=".news-item__title",
        getBody=getBody,
        imajinasi=".news-item__image",
        linkedin="https://www.rbkc.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="246",LA_name="Kensington and Chelsea",LA_pr="https://www.rbkc.gov.uk/newsroom-rbkc",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
    ...
    try:
        ...
        for a in lista:
            ...
            imajin=linkedin2+a.select_one(imajinasi).get("style") if a.select_one(imajinasi) else "" if imajinasi else ""
            imajin=re.sub("background-image: url\('|'\)","", imajin)
