...
def link324():
    getList(
        datea=None,
        content="#bodyContent > p:not(:first-child)",
        imajina=".page-image > a > img",
        pagis=1,
        getDatea=None,
        replaceRegex="\d{1,2}\s\w+\s\d{4}",
        numero="324",
        LA_name="West Dunbartonshire",
        LA_pr="https://www.west-dunbarton.gov.uk/council/newsroom/news/",
        links="https://www.west-dunbarton.gov.uk/council/newsroom/news/?pagenumber=",
        listas=".item",
        datesss=".date",
        replaceDate=None,
        title="h2",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.west-dunbarton.gov.uk",
        href="a",
        linkedin2="https://www.west-dunbarton.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="324",LA_name="West Dunbartonshire",LA_pr="https://www.west-dunbarton.gov.uk/council/newsroom/news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
