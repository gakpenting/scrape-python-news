...
def link340():
    getList(
        datea=None,
        content=".cs_control > div.columns > p:not(:first-child)",
        imajina=".img_right",
        pagis=1,
        getDatea=None,
        replaceRegex=None,
        ...
        LA_pr="https://www.westsuffolk.gov.uk/news/",
        links="https://www.westsuffolk.gov.uk/news/?pageno=",
        listas="div > div > div > div.small-12.medium-9.columns",
        datesss=".date.no_marg_top",
        replaceDate=None,
        title="h2",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.westsuffolk.gov.uk",
        href="a",
        linkedin2="https://www.westsuffolk.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="340",LA_name="West Suffolk",LA_pr="https://www.westsuffolk.gov.uk/news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
