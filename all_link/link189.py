...
def link189():
    ...
    pagis=1,
    numero="189",
    LA_name="Antrim and Newtownabbey",
    LA_pr="https://antrimandnewtownabbey.gov.uk/news/",
    links="https://antrimandnewtownabbey.gov.uk/news/?page=",
    listas=".list-item",
    datesss=".date",
    replaceDate=None,
    ...
    title="h2",
    getBody=getBody,
    content=".cell.medium-10",
    imajina="sam",
    imajinasi="img",
    linkedin="https://antrimandnewtownabbey.gov.uk",
    href="a",
    linkedin2="https://antrimandnewtownabbey.gov.uk")
        ...
        while True:
            ...
            for a in lista:
                ...
                if compareDate(s,lastDate,dayfirst):
                    ...
                    papa.image=linkedin2+newstring if newstring != "" else ""
                    papa.save()
