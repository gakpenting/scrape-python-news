...
def link302():
    getList(
        datea=None,
        content="article > p:not(:nth-child(2))",
        imajina="img.img-responsive.img-news-home",
        pagis=0,
        getDatea=None,
        replaceRegex=None,
        numero="302",
        LA_name="Lisburn and Castlereagh",
        LA_pr="https://www.lisburncastlereagh.gov.uk/news",
        links="https://www.lisburncastlereagh.gov.uk/news/P",
        listas="article.news-row",
        datesss=".col-sm-9 > p",
        replaceDate=None,
        title="h2",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.lisburncastlereagh.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="302",LA_name="Lisburn and Castlereagh",LA_pr="https://www.lisburncastlereagh.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
