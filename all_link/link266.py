...
def link266():
    getList(
        ...
        replaceRegex=None,
        numero="266",
        LA_name="Welwyn Hatfield",
        LA_pr="https://www.welhat.gov.uk/news",
        links=None,
        listas=None,
        datesss=None,
        replaceDate=None,
...
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="266",LA_name="Welwyn Hatfield",LA_pr="https://www.welhat.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
