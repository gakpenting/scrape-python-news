...
def link251():
    getList(
        ...
        numero="251",
        LA_name="Westminster",
        LA_pr="https://www.westminster.gov.uk/news",
        links="https://www.westminster.gov.uk/news",
        listas=".collections-listing > tbody:nth-child(1) > tr",
        datesss=None,
        replaceDate=None,
        title="a",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.westminster.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="251",LA_name="Westminster",LA_pr="https://www.westminster.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
