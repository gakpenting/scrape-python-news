...
def link272():
    getList(
        ...
        imajina="img[typeof='foaf:Image']",
        pagis=0,
        getDatea=getDatea,
        replaceRegex=None,
        numero="272",
        LA_name="Burnley",
        LA_pr="https://www.burnley.gov.uk/news-events",
        links="https://www.burnley.gov.uk/news-events/recent-news?page=",
        listas="article",
        datesss=None,
        replaceDate=None,
        title="h2",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.burnley.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="272",LA_name="Burnley",LA_pr="https://www.burnley.gov.uk/news-events",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
