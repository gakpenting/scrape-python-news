...
def link256():
    getList(
        ...
        numero="256",
        LA_name="Wigan",
        LA_pr="https://www.wigan.gov.uk/News/Borough-news.aspx",
        links="https://www.wigan.gov.uk/News/News.aspx?ListingNewsListingLatestNews_List_GoToPage=",
        listas=".sys_subitem",
        ...
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.wigan.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="256",LA_name="Wigan",LA_pr="https://www.wigan.gov.uk/News/Borough-news.aspx",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
