...
def link225():
    getList(
        ...
        numero="225",
        LA_name="Cambridge",
        LA_pr="https://www.cambridge.gov.uk/news",
        links="https://www.cambridge.gov.uk/news",
        listas=".main-content > .ccc-bullet > li",
        datesss=None,
        replaceDate=None,
        title="a",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.cambridge.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="225",LA_name="Cambridge",LA_pr="https://www.cambridge.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
    ...
    try:
        ...
        for a in lista:
            ...
            cop=re.search("^\d{1,2}\s\w+\s\d{1,4}", s)
