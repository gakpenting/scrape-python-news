...
def link382():
    getList(
        ...
        numero="382",
        LA_name="Gwynedd",
        LA_pr="gwynedd.llyw.cymru/en/Council/News/News.aspx",
      datea=None,
        ...
        getDatea=None,
        replaceRegex=None,
        links="https://www.gwynedd.llyw.cymru/en/Council/News/Press-releases/Press-releases.aspx?Listing_List_GoToPage=",
        listas=".sys_subitem",
        ...
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.gwynedd.llyw.cymru",
        href="a",
        linkedin2="",
        dayfirst=True
    )
