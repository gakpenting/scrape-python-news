...
def link248():
    getList(
        datea=".container > p >strong",
        content=".lbr-rte-wrapper",
        imajina="sam",
        pagis=1,
        getDatea=getDatea,
        replaceRegex=None,
        numero="248",
        LA_name="Redbridge",
        LA_pr="https://www.redbridge.gov.uk/news/",
        links="https://www.redbridge.gov.uk/news/",
        listas=".teaser",
        datesss=None,
        replaceDate=None,
        title=".title",
        getBody=getBody,
        imajinasi=".image-area > img",
        linkedin="https://www.redbridge.gov.uk",
        href="a",
        linkedin2="https://www.redbridge.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="248",LA_name="Redbridge",LA_pr="https://www.redbridge.gov.uk/news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
    ...
    try:
        ...
        for a in lista:
            ...
            if getDatea:
                s=getDatea(linkedin+a.select_one(href).get("href"),date=datea,replaceDate="Published: ")
                # print(s)
