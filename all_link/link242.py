...
def link242():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="242",LA_name="Forest of Dean",LA_pr="https://www.fdean.gov.uk/residents/latest-news-events/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
