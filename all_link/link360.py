...
def link360():
    getList(
        datea=None,
        content="#content > div.sys_none.sys_themed.sys_theme-none > div",
        imajina="#content > div.sys_none.sys_themed.sys_theme-none > div > div.sys_record-image-control > img",
        pagis=1,
        getDatea=None,
        replaceRegex=None,
        numero="360",
        LA_name="Rhondda Cynon Taf",
        LA_pr="https://www.rctcbc.gov.uk/EN/Newsroom/Newsroom.aspx",
        links="https://www.rctcbc.gov.uk/EN/Newsroom/Newsroom.aspx?pageno=",
        listas=".news-article-list",
        datesss=".news-article-time",
        replaceDate=None,
        title="h2",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.rctcbc.gov.uk",
        href="a",
        linkedin2="https://www.rctcbc.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="360",LA_name="Rhondda Cynon Taf",LA_pr="https://www.rctcbc.gov.uk/EN/Newsroom/Newsroom.aspx",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
