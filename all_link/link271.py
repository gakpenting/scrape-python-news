...
def link271():
    getList(
        datea="meta[name='DC.date']",
        content="#Content-Council > p:not(:nth-child(3)), #Content-Council > ul,#Content-Council > h2",
        imajina="sam",
        pagis=1,
        getDatea=getDatea,
        replaceRegex=None,
        numero="271",
        LA_name="Swale",
        LA_pr="https://www.swale.gov.uk/hot-off-the-press/",
        links="https://www.swale.gov.uk/hot-off-the-press/",
        listas=".TTContent",
        datesss=None,
        replaceDate=None,
        title="h2",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.swale.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="271",LA_name="Swale",LA_pr="https://www.swale.gov.uk/hot-off-the-press/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
