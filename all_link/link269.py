...
def link269():
    getList(
        datea=None,
        content=".main-content-area > *:not(.no-pad)",
        imajina=".article-feature-image",
        pagis=1,
        getDatea=None,
        replaceRegex="\d{1,2}\s\w{3}",
        numero="269",
        LA_name="Maidstone",
        LA_pr="https://news.maidstone.gov.uk/",
        links="https://news.maidstone.gov.uk/home/news?result_265920_result_page=",
        listas=".news-article",
        datesss=".date",
        replaceDate=None,
        title="h3",
...
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="269",LA_name="Maidstone",LA_pr="https://news.maidstone.gov.uk/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
