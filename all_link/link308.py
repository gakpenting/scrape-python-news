...
def link308():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="308",LA_name="Newark and Sherwood",LA_pr="https://www.newark-sherwooddc.gov.uk/#horizontalTab3",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
