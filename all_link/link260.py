...
def link260():
    getList(
        ...
        numero="260",
        LA_name="Portsmouth",
        LA_pr="https://www.portsmouth.gov.uk/Ext/AllNews?keywords=",
        links="https://www.portsmouth.gov.uk/Ext/AllNews?keywords=",
        listas=".news-container",
        datesss=".news-date",
        replaceDate="Published:",
        title="h3",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.portsmouth.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="260",LA_name="Portsmouth",LA_pr="https://www.portsmouth.gov.uk/Ext/AllNews?keywords=",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
