...
def link240():
    getList(
        ...
        numero="240",
        LA_name="Rochford",
        LA_pr="https://www.rochford.gov.uk/business/business-news-and-events",
        links=None,
        listas=None,
        datesss=None,
        replaceDate=None,
...
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="240",LA_name="Rochford",LA_pr="https://www.rochford.gov.uk/business/business-news-and-events",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
