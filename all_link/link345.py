...
def link345():
    getList(
        datea=None,
        content=".a-body--newsitembody",
        imajina=".newsitem__relatedimage",
        pagis=1,
        getDatea=None,
        replaceRegex=None,
        numero="345",
        LA_name="Gateshead",
        LA_pr="https://www.gateshead.gov.uk/article/1759/News",
        links="https://www.gateshead.gov.uk/article/1759/News?q=*&p=",
        listas=".newshub__otheritem--fullwidth", 
        datesss=".searchresults__itemurl",
        replaceDate=None,
        title=".searchresults__itemtitle",
        getBody=getBody,
        imajinasi="sam",
        linkedin="",
        href="a",
...
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="345",LA_name="Gateshead",LA_pr="https://www.gateshead.gov.uk/article/1759/News",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
