...
def link359():
    getList(
        ...
        pagis=1,
        getDatea=getDatea,
        replaceRegex="\d{1,2}(st|rd|th|nd)\s\w+\s\d{4}",
        numero="359",
        LA_name="Newport",
        LA_pr="http://www.newport.gov.uk/en/Council-Democracy/News/News-home.aspx",
        links="http://www.newport.gov.uk/en/Council-Democracy/News/News.aspx?fullNewsListing_List_GoToPage=",
        listas="#fullNewsListing_List > ul > li",
        datesss="div",
        replaceDate=None,
        title=".newsItemTitle",
        getBody=getBody,
        imajinasi="sam",
        linkedin="http://www.newport.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="359",LA_name="Newport",LA_pr="http://www.newport.gov.uk/en/Council-Democracy/News/News-home.aspx",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
