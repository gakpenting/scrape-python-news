...
def link379():
    getList(
        ...
        numero="379",
        LA_name="Wychavon",
        LA_pr="https://www.wychavon.gov.uk/news-and-alerts",
      datea=None,
        content=".ebd-block",
        ...
        links="https://www.wychavon.gov.uk/news-and-alerts?start=",
        listas=".eb-post",
        ...
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.wychavon.gov.uk",
        href="a",
        linkedin2="https://www.wychavon.gov.uk"
    )
