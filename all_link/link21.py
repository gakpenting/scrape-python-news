...
def link21():
    getList(
      ...
      datea=None,
        content=".field-name-field-news-description > div > .field-item.even > p",
        imajina=".img-responsive",
        pagis=0,
        getDatea=None,
        replaceRegex=None,
        links="https://www.aylesburyvaledc.gov.uk/news?page=",
        ...
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.aylesburyvaledc.gov.uk/",
        href="a",
        linkedin2="",
        dayfirst=False
    )
