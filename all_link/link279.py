...
def link279():
    getList(
        ...
        replaceRegex=None,
        numero="279",
        LA_name="West Lancashire",
        LA_pr="https://www.westlancs.gov.uk/news.aspx",
        links="https://www.westlancs.gov.uk/news.aspx",
        listas="#wrap > div.container > div > div.span8 > ul:nth-child(4) > li",
        datesss=".date",
...
def getList(dayfirst=False,datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="279",LA_name="West Lancashire",LA_pr="https://www.westlancs.gov.uk/news.aspx",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
