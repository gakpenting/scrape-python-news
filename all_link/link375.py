...
def link375():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="375",LA_name="Wakefield",LA_pr="https://www.wakefield.gov.uk/about-the-council/newsroom",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
