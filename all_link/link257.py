...
def link257():
    getList(
        datea=None,
        content="#mainContent > *:not(.pressinfo):not(div):not(h1)",
        imajina="sam",
        pagis=1,
        getDatea=None,
        replaceRegex=None,
        ...
        LA_pr="https://www.basingstoke.gov.uk/our-news-and-media",
        links="https://www.basingstoke.gov.uk/our-news-and-media",
        listas=".llinks_li",
        datesss=".pressdate",
        replaceDate=None,
        title="a > *:not(.pressdate)",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.basingstoke.gov.uk/",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="257",LA_name="Basingstoke and Deane",LA_pr="https://www.basingstoke.gov.uk/our-news-and-media",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
