...
def link377():
    getList(
        ...
        replaceRegex=None,
        numero="377",
        LA_name="Malvern Hills",
        LA_pr="https://www.malvernhills.gov.uk/news-alerts",
        links="https://www.malvernhills.gov.uk/news-alerts?start=",
        listas=".eb-post",
        datesss=".eb-meta-date",
        replaceDate=None,
        title=".eb-post-title",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.malvernhills.gov.uk",
        href="a",
        linkedin2="https://www.malvernhills.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="377",LA_name="Malvern Hills",LA_pr="https://www.malvernhills.gov.uk/news-alerts",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
