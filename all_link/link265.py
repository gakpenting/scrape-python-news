...
def link265():
    getList(
        ...
        imajina="#editorContent > p > img",
        pagis=0,
        getDatea=None,
        replaceRegex=None,
        numero="265",
        LA_name="Three Rivers",
        LA_pr="https://www.threerivers.gov.uk/listing/news",
        links="https://www.threerivers.gov.uk/listing/news?offset=",
        listas=".story",
        datesss=".date",
        replaceDate=None,
        title="h3",
        ...
        linkedin="",
        href="a",
        linkedin2="https://www.threerivers.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="265",LA_name="Three Rivers",LA_pr="https://www.threerivers.gov.uk/listing/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
