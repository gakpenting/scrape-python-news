...
def link228():
    getList(
        ...
        replaceRegex=None,
        numero="228",
        LA_name="Cheshire West and Chester",
        LA_pr="https://www.cheshirewestandchester.gov.uk/news-and-views/news-and-views.aspx",
        links=None,
        listas=None,
        datesss=None,
        replaceDate=None,
...
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="228",LA_name="Cheshire West and Chester",LA_pr="https://www.cheshirewestandchester.gov.uk/news-and-views/news-and-views.aspx",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
