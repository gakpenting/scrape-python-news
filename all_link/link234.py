...
def link234():
    getList(
        ...
        getDatea=None,
        replaceRegex=None,
        numero="234",LA_name="Teignbridge",LA_pr="https://www.teignbridge.gov.uk/news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="234",LA_name="Teignbridge",LA_pr="https://www.teignbridge.gov.uk/news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
