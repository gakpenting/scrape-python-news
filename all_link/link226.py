...
def link226():
    ...
    numero="226",
    LA_name="Fenland",
    LA_pr="https://www.fenland.gov.uk/news",
    links="https://www.fenland.gov.uk/news?p=",
    listas=None,
    datesss=None,
    replaceDate=None,
    title=None,
    ...
    href="a",
    linkedin2="")
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="226",LA_name="Fenland",LA_pr="https://www.fenland.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
