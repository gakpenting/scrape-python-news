...
def link232():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="232",LA_name="Erewash",LA_pr="https://www.erewash.gov.uk/index.php/news-and-events/latest-news-mnu.html",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
