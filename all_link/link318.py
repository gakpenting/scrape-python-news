...
def link318():
    getList(
        datea=None,
        content=".article-container-public-content",
        imajina=".article-container-public-content > p > img",
        pagis=1,
        getDatea=None,
        numero="318",
        LA_name="Fife",
        LA_pr="https://www.fife.gov.uk/news",
    links="https://www.fife.gov.uk/news?sort=date&profile=news&gscope1=7&&start_rank=",
        listas=".search-result-news:not(.news-promo-box)",
        datesss=".news-date-info",
