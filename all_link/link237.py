...
def link237():
    getList(
        datea=".a-body",
        content=".a-body > p:not(:nth-last-child(2))",
        imajina="sam",
        pagis=1,
        getDatea=getDatea,
        replaceRegex="None",
        numero="237",
        LA_name="Basildon",
        LA_pr="https://www.basildon.gov.uk/news",
        links="https://www.basildon.gov.uk/article/7000/News?p=",
        listas="div > li",
        datesss=None,
        replaceDate=None,
        title="a",
...
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="237",LA_name="Basildon",LA_pr="https://www.basildon.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
    ...
    try:
        ...
        while True:
            ...
            for a in lista:
                ...
                if getDatea:
                    s=getDatea(linkedin+a.select_one(href).get("href"),date=datea,replaceRegex="Published on\s\w+\s\d{1,2}\s\w+\s\d{1,4}")
                
                s=s.replace("Published on ","")
