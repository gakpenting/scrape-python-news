...
def link394():
    ...
    numero="394",
    LA_name="Chichester",
    LA_pr="https://www.chichester.gov.uk/latestnews",
    links="http://www.chichester.gov.uk/custom/feed.ashx?articleid=24582",
    listas="item",
    datesss="pubDate",
    replaceDate=None,
    titles="title",
    getBody=getBody,
    content="#bodytext",
    imajina="#slider-related-inline-assets > div > img",
    imajinasi="sam",
    linkedin="",
    href="link",
    linkedin2="")
