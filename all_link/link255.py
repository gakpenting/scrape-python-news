...
def link255():
    getList(
        ...
        numero="255",
        LA_name="Tameside",
        LA_pr="https://www.tameside.gov.uk/Newsroom",
        links="https://www.tameside.gov.uk/Newsroom",
        listas=".newsitem",
        datesss=".date",
        replaceDate="Published",
        title="span.blue",
        getBody=getBody,
        imajinasi="img.ClassName",
        linkedin="https://www.tameside.gov.uk",
        href="a",
        linkedin2="https://www.tameside.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="255",LA_name="Tameside",LA_pr="https://www.tameside.gov.uk/Newsroom",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
