...
def link376():
    getList(
        datea=None,
        content=".a-body.a-body--newsitem",
        imajina="#maincontent > div > div.a-relimage.a-relimage--newsitem > img",
        pagis=1,
        getDatea=None,
        replaceRegex="\d{1,2}\s\w+\s\d{4}",
        numero="376",
        LA_name="Wiltshire",
        LA_pr="http://www.wiltshire.gov.uk/news",
        links="https://www.wiltshire.gov.uk/news?sort=displaystartdate+desc&p=",
        listas=".news-item",
        datesss=".news-item__published-date",
        replaceDate=None,
        title=".news-item__heading",
        getBody=getBody,
        imajinasi="sam",
        linkedin="",
        href="a",
...
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="376",LA_name="Wiltshire",LA_pr="http://www.wiltshire.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
