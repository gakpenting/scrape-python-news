...
def link343():
    getList(
        ...
        numero="343",
        LA_name="Runnymede",
        LA_pr="https://www.runnymede.gov.uk/article/15611/News",
        links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="343",LA_name="Runnymede",LA_pr="https://www.runnymede.gov.uk/article/15611/News",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
