...
def link392():
    getList(
      ...
      datea=None,
        content="div.field.field-name-body.field-type-text-with-summary.field-label-hidden",
        imajina="div.field.field-name-field-header-image.field-type-image.field-label-hidden > div > div > img",
        pagis=0,
        getDatea=None,
        replaceRegex=None,
        links="https://www.walthamforest.gov.uk/media?page=",
        listas="#block-system-main > div > div.view-content > div.views-row",
        datesss=".views-field-created",
        replaceDate=None,
        title=".views-field-title",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.walthamforest.gov.uk",
        href="a",
        linkedin2="",
        dayfirst=False
    )
