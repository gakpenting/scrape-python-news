...
def link373():
    getList()
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="373",LA_name="Bradford",LA_pr="https://www.bradford.gov.uk/browse-all-news/press-releases/current-news-releases/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
