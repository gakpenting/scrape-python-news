...
def link280():
    getList(
        ...
        numero="280",
        LA_name="Charnwood",
        LA_pr="https://www.charnwood.gov.uk/pages/charnwoodnews",
        links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="280",LA_name="Charnwood",LA_pr="https://www.charnwood.gov.uk/pages/charnwoodnews",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
