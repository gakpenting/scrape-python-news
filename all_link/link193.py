...
def link193():
    ...
    numero="193",
    LA_name="Mid Ulster",
    LA_pr="https://www.midulstercouncil.org/news",
    links="https://www.midulstercouncil.org/news?page=",
    listas=".article-teaser > li",
    datesss=".date",
    replaceDate=None,
    replaceRegex=None,
    getDatea=None,
    ...
    imajina="sam",
    imajinasi="sam",
    linkedin="https://www.midulstercouncil.org",
    href=".btn-main",
    linkedin2="https://www.midulstercouncil.org")
