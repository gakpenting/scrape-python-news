...
def link339():
    getList(
        datea=None,
        content="#block-system-main > div > div > div > div.bryant-content.bryant-content-region.panel-panel > div > div.panel-pane.pane-entity-view.pane-node > div > div > div.field.field-name-body.field-type-text-with-summary.field-label-hidden > div > div",
        imajina=".main-news-image",
        pagis=0,
        getDatea=None,
        replaceRegex="\d{1,2}(th|st|nd|rd)\s\w+\s\d{4}",
        numero="339",
        LA_name="Ipswich",
        LA_pr="https://www.ipswich.gov.uk/content/local-business-news",
        links="https://www.ipswich.gov.uk/all-news?page=",
        listas=".views-row",
        datesss="div > *:not(span)",
        replaceDate=None,
        title="h2",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.ipswich.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="339",LA_name="Ipswich",LA_pr="https://www.ipswich.gov.uk/content/local-business-news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
    ...
    try:
        ...
        while True:
            ...
            for a in lista:
                ...
                s=None
                # print(a.select_one(datesss).getText())
                if datesss:
