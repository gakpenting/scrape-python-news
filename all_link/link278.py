...
def link278():
    getList(
        ...
        replaceRegex=None,
        numero="278",
        LA_name="South Ribble",
        LA_pr="https://www.southribble.gov.uk/content/news-and-media",
        links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="278",LA_name="South Ribble",LA_pr="https://www.southribble.gov.uk/content/news-and-media",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
