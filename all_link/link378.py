...
def link378():
    getList(
           numero="378",
        LA_name="Worcester",
        LA_pr="https://www.worcester.gov.uk/news",
        datea=None,
        content=".ebd-block",
        ...
        links="https://www.worcester.gov.uk/news?start=",
        listas=".eb-post",
        ...
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.worcester.gov.uk",
        href="a",
        linkedin2="https://www.worcester.gov.uk"
     
       
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="378",LA_name="Worcester",LA_pr="https://www.worcester.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
