...
def link335():
    getList(
        ...
        imajina=".news-image-wrapper > div > img",
        pagis=1,
        getDatea=None,
        replaceRegex="\d{1,2}\s\w+\s\d{4}",
        numero="335",
        LA_name="South Staffordshire",
        LA_pr="https://www.sstaffs.gov.uk/news/",
        links="https://www.sstaffs.gov.uk/news/news.cfm/current/",
        ...
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.sstaffs.gov.uk",
        href="a",
        linkedin2="https://www.sstaffs.gov.uk"
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="335",LA_name="South Staffordshire",LA_pr="https://www.sstaffs.gov.uk/news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
