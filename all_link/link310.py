...
def link310():
    getList(
        ...
        LA_pr="http://www.southoxon.gov.uk/news-and-events",
        links="http://www.southoxon.gov.uk/news?page=",
        listas=".news-article",
        datesss=".meta",
        replaceDate=None,
        title="h2",
        getBody=getBody,
        imajinasi="sam",
        linkedin="http://www.southoxon.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="310",LA_name="South Oxfordshire",LA_pr="http://www.southoxon.gov.uk/news-and-events",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
