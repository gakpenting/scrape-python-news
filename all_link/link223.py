...
def link223():
    getList(datea=None,
    content="article > *:not(.date):not(h1)",
    imajina="sam",
    pagis=1,
    getDatea=None,
    replaceRegex=None,
    numero="223",
    LA_name="Windsor and Maidenhead",
    LA_pr="https://www3.rbwm.gov.uk/news",
    links="https://www3.rbwm.gov.uk/news",
    listas="article.listing",
    datesss="p.listing__meta.listing__meta--date",
    ...
    href="a",
    linkedin2="")
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="223",LA_name="Windsor and Maidenhead",LA_pr="https://www3.rbwm.gov.uk/news",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
