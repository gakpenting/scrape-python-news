...
def link370():
    getList(
        ...
        numero="370",
        LA_name="Crawley",
        LA_pr="http://www.crawley.gov.uk/pw/News_and_Events/Press_Releases/index.htm",
        links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="370",LA_name="Crawley",LA_pr="http://www.crawley.gov.uk/pw/News_and_Events/Press_Releases/index.htm",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
