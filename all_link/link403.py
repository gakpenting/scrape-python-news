...
def link403():
    getList(
        ...
        numero="403",
        LA_name="Middlesbrough",
        LA_pr="middlesbrough.gov.uk/news",
      datea=None,
        ...
        getDatea=None,
        replaceRegex=None,
        links="https://www.middlesbrough.gov.uk/news?page=",
        listas="#block-system-main > div > div.view-content > div.views-row",
        datesss=".date-display-single",
        replaceDate=None,
        title=".title",
        getBody=getBody,
        imajinasi="sam",
        linkedin="https://www.middlesbrough.gov.uk",
        href="a",
        linkedin2=""
    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="379",LA_name="Wychavon",LA_pr="https://www.wychavon.gov.uk/news-and-alerts",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
    ...
    try:
        ...
        while True:
            ...
            for a in lista:
                ...
                s=None
                if datesss:
                    s=a.select_one(datesss).get("content") if a.select_one(datesss).get("content") else a.select_one(datesss).get("content")
                if replaceRegex:
                ...
                # print(a.select_one(datesss).get("content"))
