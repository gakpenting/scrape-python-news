...
def link235():
    getList(
datea=None,
content=".er-filter-block-wrapper > .er-filter-block.content:nth-of-type(2) > p",
imajina="sam",
pagis=1,
getDatea=None,
replaceRegex=r"\d{1,2}\s\w{3}\s\d{1,4}",
numero="235",
LA_name="East Riding of Yorkshire",
LA_pr="https://www.eastriding.gov.uk/say/news/",
links="https://www.eastriding.gov.uk/say/news/",
listas=".er-filter-row:not(.er-filter-header)",
datesss=".date",
replaceDate=None,
title=".content",
getBody=getBody,
imajinasi="sam",
linkedin="https://www.eastriding.gov.uk",
href="a",
linkedin2=""

    )
def getList(datea=None,content="sam",imajina="",pagis=1,getDatea=None,replaceRegex=None,numero="235",LA_name="East Riding of Yorkshire",LA_pr="https://www.eastriding.gov.uk/say/news/",links=None,listas=None,datesss=None,replaceDate=None,title=None,getBody=None,imajinasi=None,linkedin="",href="a",linkedin2=""):
